    ...
    },
    {
        ...
        content: (
            <div>
                ...
                <p>The commands this setup gives you in your command line are&nbsp;<code className=" language-javascript">gulp sass</code> and <code className=" language-javascript">gulp watch</code>.</p>
                <p>Basically, <code className=" language-javascript">gulp sass</code> will run the compilation for you, and then end. <code className=" language-javascript">gulp watch</code> on the other hand, will watch the sass files for changes, so when you save any of the files, it will automagically re-run the compilation for you.</p>
                <hr />
